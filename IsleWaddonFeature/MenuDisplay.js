...
var L1 = window.tooltipTextStart + "<font color='#48edff'>   ISLEWADDON</font>", L1_1 = window.tooltipTextEnd + "<font color='#ffeb38'>By Bored#6017<br>Enjoy this add-on :p</font><br>I can't guarantee this add-on doesn't produce lag/fps drops or any issues<br>Notify me (Bored#6017) of any bugs/problems on Discord" + window.tooltipTextEndLine;
...
var L4 = window.tooltipTextStart + "", L4_1 = window.tooltipTextEnd + "Direct link to<br>► Official wiki" + window.tooltipTextEndLine;
...
window.MenuAddon = function () {
    ...
    //
    var drawButtonLinkW = '<button id="ButtonLinkW" style="float:left; color:rgb(0,0,0); width:185px; background:rgb(139,145,232);" onclick="window.ButtonLinkW()" type="button">Wiki</button>';
    ...
    src += L4 + L4_1 + drawButtonLinkW + window.endTableElem;
    //
...
window.ButtonLinkL = function () {
    jQuery(".isleWaddon-uiMenu").remove();
    window.MenuAddon();
    window.open(window.IsleWaddonVersion + '/Version_Log.text', '_blank');
}
...
window.ButtonPressMap = function () {
    ...
    if (window.gameStarted == "true") {
        ...
        if (window.MapSTATUS == "false") {
            window.getScript(window.IsleWaddonVersion + "/IsleWaddonFeature/MiniMap.js");
        }
...
window.ButtonPressCombatLog = function () {
    if (window.CombatLogSTATUS == "true") {
        ...
        if (window.combatLogLoaded != "true") {
            window.getScript(window.IsleWaddonVersion + "/IsleWaddonFeature/CombatLog.js");
