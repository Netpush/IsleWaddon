// RUNE DATA
window.getScript(window.IsleWaddonVersion + "/IsleWaddonFeature/BetterInventory/ToolTipExpand/RuneData.js");
    ...
    if (window.StatsRangeSTATUS == "true") {
        ...
        if (obj.level == 20 || obj.originalLevel == 20 || (obj.level + obj.stats.lvlRequire) == 20) {
            ...
            $('.uiTooltipItem .tooltip .stats').each(function () {
                ...
                text = $(this).html();
                $(this).html(text.replaceAll("life gained on hit", "life gained on hit <font color=" + colorTooltip + ">[1-10]</font>"));
...
// ROD
function expandFishingRodTooltip() {
    if (window.StatsRangeSTATUS == "true") {
